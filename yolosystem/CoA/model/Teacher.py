...
import math
import argparse
import sys # 添加 sys 用于修改路径

# 将 run/YOLOsystem 添加到路径，以防模块找不到
current_dir = os.path.dirname(os.path.abspath(__file__))
coa_root = os.path.dirname(current_dir) # 获取 /data/home/sczd119/run/YOLOsystem/yolosystem/CoA
sys.path.append(coa_root)

try:
    from data.data_loader import RESIDE_Dataset  # 确保导入正确
except ImportError:
    pass # 忽略 ImportError, 以防止其他文件从这里导入 Teacher 失败
